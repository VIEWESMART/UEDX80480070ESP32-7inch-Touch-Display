...
{
	gpio_pad_select_gpio(GPIO_NUM_47);
...
static void st7796s_set_orientation(uint8_t orientation)
{
	...
	ESP_LOGI(TAG, "显示方向: %s", orientation_str[orientation]);
	...
	ESP_LOGI(TAG, "0x36 命令值: 0x%02X", data[orientation]);

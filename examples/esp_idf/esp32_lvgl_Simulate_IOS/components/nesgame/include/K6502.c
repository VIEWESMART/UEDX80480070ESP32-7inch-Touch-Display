...
#define AA_ABS   ({ BYTE temp1 = K6502_Read( PC++ ); BYTE temp2 = K6502_Read( PC++ ); (WORD)temp2 << 8 | temp1; })
// Absolute2 ( PC-- )
// #define AA_ABS2  ( K6502_Read( PC++ ) | (WORD)K6502_Read( PC ) << 8 )
#define AA_ABS2  ({ BYTE temp1 = K6502_Read( PC++ ); BYTE temp2 = K6502_Read( PC ); (WORD)temp2 << 8 | temp1; })
// Absolute,X
